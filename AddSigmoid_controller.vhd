...
entity AddSigmoid_controller is
 port (
...
end AddSigmoid_controller;

architecture Behavioral of AddSigmoid_controller is
 Type State_type is (
    S_reset, S_start,
    ...
    S_delay13, S_delay14,
    S_write,
    S_delay15, S_delay16, S_delay17, S_delay18, S_delay19, S_delay20,
    S_delay21, S_delay22, S_delay23, S_delay24, S_delay25, S_delay26,
    S_delay27, S_delay28,
    S_end
 );
   ...
   begin
	if (RST='1') then
		...
		case state is
			...
			when S_write =>
			 if (HW_comp = '1') then state <= S_delay15;
			 else                    state <= S_write;
			 end if;
