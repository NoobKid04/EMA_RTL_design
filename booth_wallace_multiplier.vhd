...
entity booth_wallace_multiplier is
    port (
        X      : in  STD_LOGIC_VECTOR(15 downto 0);
        Y      : in  STD_LOGIC_VECTOR(15 downto 0);
        result : out STD_LOGIC_VECTOR(15 downto 0)
    );
end booth_wallace_multiplier;

architecture rtl of booth_wallace_multiplier is
...
begin
	...
	result <= final_sum(23 downto 8) when (final_sum(31 downto 23) = "000000000" or final_sum(31 downto 23) = "111111111")
          else x"7FFF" when final_sum(31) = '0'
          else x"8000";
end rtl;
